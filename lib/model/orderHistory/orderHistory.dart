...
class Data {
  int currentPage;
  List<DataOrderHistory> dataInner;
  String firstPageUrl;
  int from;
  int lastPage;
  String lastPageUrl;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      dataInner = new List<DataOrderHistory>();
      json['data'].forEach((v) {
        dataInner.add(new DataOrderHistory.fromJson(v));
      });
    }
...
class DataOrderHistory {
  ...
  DataOrderHistory.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
